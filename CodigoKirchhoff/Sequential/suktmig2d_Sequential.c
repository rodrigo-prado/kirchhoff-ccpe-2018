...
void migkt2d (const float * const * data,const int  ntr,const int  nt,const float  dx,const float  dt,const float  tmax, 
              const int  nfft,const float  fnyq,const float  h,const float * fc,const int  nf,const int  nc,const int  nfc, 
              const int  cdp_trace_first,const float  angmax,const float * const* vel, float **  mig,const int  dxcdp,const int  firstcdp);    
