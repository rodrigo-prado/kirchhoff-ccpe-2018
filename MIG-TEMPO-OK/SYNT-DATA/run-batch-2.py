...
exec_parallel_omp(repeat, 8, 5, 10)
exec_parallel_mpi(repeat, 8, 5, 10)
exec_parallel_omp(repeat, 8, 5, 20)
exec_parallel_mpi(repeat, 8, 5, 20)
exec_parallel_omp(repeat, 8, 5, 30)
exec_parallel_mpi(repeat, 8, 5, 30)
exec_parallel_omp(repeat, 8, 5, 40)
exec_parallel_mpi(repeat, 8, 5, 40)
